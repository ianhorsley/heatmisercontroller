...
class MockHeatmiserAdaptor(HeatmiserAdaptor):
    ...
    def write_to_device(self, network_address, protocol, dcb_address, length, payload):
        self.arguements.append((network_address, protocol, dcb_address, length, payload))
    ...
    def read_from_device(self, network_address, protocol, dcb_start_address, expectedLength, readall = False):
        self.arguements.append((network_address, protocol, dcb_start_address, expectedLength, readall))
...
class test_protocol(unittest.TestCase):
    ...
    def test_setfield_1(self):
        ...
        self.assertEqual(self.tester.arguements,(5, 3, 17, 1, [7]))
    ...
    def test_setfield_2(self):
        ...
        self.assertEqual(self.tester.arguements,(5, 3, 43, 4, loctime))
