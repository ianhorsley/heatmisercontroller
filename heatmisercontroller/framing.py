...
def _check_response_frame_function(protocol, expectedFunction, data):
...
def _verify_response(protocol, source, destination, expectedFunction, expectedLength, data) :
    ...
    try:
        ...
        # check function
        _check_response_frame_function(protocol, expectedFunction, data)
